$(document).ready(function(){
        ...
        $(".comment-container").delegate(".reply","click",function(){
            ...
            well.find(".reply-form").empty().append(form);

        });
        
        
        $(".comment-container").delegate(".vote","click",function(){
	        	var comment_id = $(this).attr("comment_id_vote");
	        	var token = $(this).attr("token");
	        	var well = $(this).parent().parent();
	        	$.ajax({
	                    url : "/vote",
	                    method : "POST",
	                    data : {_token: token, comment_id : comment_id},
	                    success:function(response){
	                    	// console.log(response.data);
	                    	$("#comment_voting_count_"+comment_id).empty().append(response.count);
	                }
	            });
        ...
        $(".comment-container").delegate(".reply-to-reply","click",function(){
            ...
            well.find(".reply-to-reply-form").empty().append(form);
